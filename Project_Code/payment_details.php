...
<div class="container mt-5">
    <h2 class="text-center mb-4">Your Appointments Receipt</h2>
                ...
                <div class="card shadow-lg">
                    <div class="card-body">
                        ...
                        <?php if (!empty($appointment['mobile_num'])) { ?>
                            <hr>
                            <h5 class="card-title text-center text-primary">Payment Information</h5>
                            <p class="card-text">
                            ...
                            <h6 class="card-title text-center text-success">Payment Confirmed..</h6>
